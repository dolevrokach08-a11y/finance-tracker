/* GENERATED from tax-optimizer.src.jsx — source sha256:68f30543dc63ec4b
...
function App() {
  ...
  const runCPISim = useCallback(async () => {
    ...
    try {
      ...
      const rows = holdings.map(h => {
        ...
        const totalValueILS = Number(h.currentPrice || 0) * Number(h.shares || 0) * (h.currency === 'ILS' ? 1 : rates[h.currency] ?? 3.6);
        return {
          symbol: h.symbol,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    text: "הנתונים מהמעקב הפיננסי הם נטו (מה שנכנס לחשבון). יחס זה מכפיל את הנטו לברוטו משוער.\n\nלחלופין — העלה תלושי משכורת למעלה לחישוב מדויק.\n\n• 1.00 = כבר ברוטו\n• 1.07 = ללא מס (רק ביטוח לאומי+בריאות)\n• 1.20 = מדרגת 10%\n• 1.26 = מדרגת 14%"
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
  ...
  }, "\u274C ", cpiError), cpiSim && cpiSim.rows.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "10px 14px",
      borderRadius: 8,
